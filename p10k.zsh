...
() {
  ...
  # Show mise segment only when there is a .mise.toml or .tool-versions file in the current
  # directory or any parent directory.
  typeset -g POWERLEVEL9K_MISE_SHOW_ON_UPGLOB='.mise.toml|.tool-versions'

  # Hide tool versions that are the same as global.
  ...
  typeset -g POWERLEVEL9K_MISE_NEOVIM_FOREGROUND=70
